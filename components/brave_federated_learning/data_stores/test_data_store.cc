...
#include "brave/components/brave_federated_learning/data_stores/test_data_store.h"
...
void BindSampleLogToStatement(
    const brave::federated_learning::TestTaskLog& test_log,
    sql::Statement* s) {
...
bool TestDataStore::Init(const std::string& task_id,
